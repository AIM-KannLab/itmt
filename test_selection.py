...
if  __name__ == '__main__':
    ...
    parser.add_argument('--model_weight_path','-m', type = str, default = 'model/densenet_models/test/brisk-pyramid.hdf5', 
                        help = 'File path of well-trained model weight')
    parser.add_argument('--csv_write_path','-c', type = str, default = 'data/curated_test/final_test/Cancer_Slice_Prediction.csv',
                        help = 'File path of well-trained model weight')
