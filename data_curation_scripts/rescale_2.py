...
input_path = "/media/sda/Anna/TM2_segmentation/data/rescaling_experiments/raw_down2/"
save_to = '/media/sda/Anna/TM2_segmentation/data/rescaling_experiments/raw_down2_reg/'
...
df.to_csv(path_or_buf= "data/Dataset_down2.csv",header = ['AGE_M','SEX','SCAN_PATH','Filename','dataset'])
