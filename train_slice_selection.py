...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', '-d',type = str, default = 'data/slice_detection_w_pseudo2/',
                        help = 'Location of the training data directory')
    parser.add_argument('--model_dir', '-m',type = str, default = 'model/densenet_models/train', 
    ...
    parser.add_argument('--load_weights', '-w', #default='model/densenet_models/test/clear-water.hdf5',
                        help = 'load these weights and continue training')

    parser.add_argument('--gpus', '-g', type = int, default = 1, help = 'number of gpus')
    parser.add_argument('--learning_rate', '-l', type = float, default = 0.0005, help = 'learning rate')
    ...
    parser.add_argument('--growth_rate', default = 12, type = int, help = "densenet growth rate (k) parameter") #12
