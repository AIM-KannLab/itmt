...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir','-i', type = str, default= 'data/curated_test/final_test/z/',
    ...
    parser.add_argument('--slice_csv_path','-c', type = str, default = 'data/curated_test/final_test/Dataset_test_rescaled.csv',
                        help = 'Metadata path')
    
    parser.add_argument('--output_dir','-o', type = str, 
                        default = 'data/curated_test/final_test/predictions_seg_filtered/',
