...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', '-d',type = str, default = 'data/segmentations_itmt2.0/',
    ...
    parser.add_argument('--load_weights','-w', default ='model/unet_models/test/itmt1.hdf5', 
                        help  =  'load weights in this file to initialise model')
