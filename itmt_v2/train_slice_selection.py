...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', '-d',type = str, default = 'data/slice_detection_itmt2.0/',
    ...
    parser.add_argument('--load_weights', '-w', default = 'model/densenet_models/test/itmt1.hdf5', 
                        help = 'load these weights and continue training')

    parser.add_argument('--gpus', '-g', type = int, default = 1, help = 'number of gpus')
    parser.add_argument('--learning_rate', '-l', type = float, default = 0.00005, help = 'learning rate')
