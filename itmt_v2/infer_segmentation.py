...
def major_voting(image_array_2d, model_segmentation):
    ...
    left_half_result = np.mean(list_of_left_muscle_preds_halved, axis=0)<=softmax_threshold  #itmt 1< itmt2 >
    right_half_result = np.mean(list_of_right_muscle_preds_halved, axis=0)<=softmax_threshold 
